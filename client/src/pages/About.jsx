...
const About = () => {
  return (
    <section className="about">
      ...
      <Row gutter={[16, 16]} className="feature-row">
        ...
        <Col xs={24} sm={24} md={8}>
          <Card title="Consolidated Listings">
            Space Seekers centralizes housing and roommate listings from diverse
            sources.
          </Card>
        </Col>
        <Col xs={24} sm={24} md={8}>
      ...
      <Paragraph>
        The key objectives of Space Seekers include prioritizing compatibility,
        streamlining the search process, enhancing safety, and providing a
